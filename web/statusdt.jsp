<%-- 
    Document   : statusdt
    Created on : 14-Sep-2023, 2:36:36 pm
    Author     : smita
--%>
...
<html>
    ...
    <body>
        ...
        <%
          ...
          String greid =request.getParameter("id");
          try{
            Class.forName("oracle.jdbc.driver.OracleDriver");
            Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","SYSTEM","IMIT@1");
            PreparedStatement ps = con.prepareStatement("select * from query where greid=? ");
            ps.setString(1,greid);
